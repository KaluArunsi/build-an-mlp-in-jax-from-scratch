...
Implemented a multi-layer perceptron end-to-end in JAX, from PRNG key handling and parameter initialization to forward passes, loss, autodiff, and SGD training. Produced a fully working classifier trained with jax.grad and pure functional updates.
